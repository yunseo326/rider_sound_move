...
class LidarScan(Node):
    def __init__(self):
        ...
        self.model.load_state_dict(torch.load('/home/muwon/Lider_sound_move-master/robot_connection-master/src/my_test_pkg_py/my_test_pkg_py/pt/4action_4_model.pt'))
        self.model.eval()
